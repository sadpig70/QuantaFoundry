...
사용:  python -m qf_witness.ops.oracle_rollback_protocol
"""
...
def main():
    ...
    doc = [
        ...
        "## 무결성 점검\n",
        "```\npython -m qf_witness.ops.oracle_rollback_protocol\n```",
        ...
        "   - 새 `registry_root_hash` 확인 → `python -m qf_witness.registry.citation_gen` 로 CITATION 갱신.\n"
        ...
        "`python -m qf_witness.registry.registry_tools dependents <id>` 로 계산.\n",
        "## 불변 제약\n",
