...
사용:
  python -m qf_witness.registry.registry_tools build           # 그래프+manifest 생성
  python -m qf_witness.registry.registry_tools dependents <id> # blast-radius: 해당 모듈/앱에 의존하는 전부
"""
