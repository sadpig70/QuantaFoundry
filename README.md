...
- **93 sealed modules · 425 sealed applications** · registry root `797e5575345b…`
...
# expect: REPRODUCED · root_hash 797e5575345b… · second_oracle 83/83 · behavior pass
```
...
- **Shor period-finding** that factors 15 = 3×5 and **genuinely 21 = 3×7**, up to a distinct-prime
  structural frontier (`shor69 … shor187 … shor3683`, 21 apps, sealed via a `c7x→c12x` multi-control
  ...
  the latest being `shor187 = 11×17` at 16 qubits with an exhaustive 65536/65536 basis-permutation check).
