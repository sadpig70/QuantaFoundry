...
- **Shor period-finding** that factors 15 = 3×5 and **genuinely 21 = 3×7**, up to a distinct-prime
  structural frontier (`shor69 … shor203 … shor3683`, 22 apps, sealed via a `c7x→c12x` multi-control
  ...
  the latest being `shor203 = 7×29` at 16 qubits with an exhaustive 65536/65536 basis-permutation check).
