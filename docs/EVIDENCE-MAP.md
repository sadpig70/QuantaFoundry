...
|---|---|---|---|---|---|
| 1 | The whole registry (95 modules / 493 apps) reproduces byte-identically | `python scripts/reproduce_all.py` | `REPRODUCED`, root `6d0f0c62ca614f09…` | `reports/REPRODUCE-RESULT.json`, `registry/REGISTRY-MANIFEST.json` | **Determinism, not correctness** (INV-R1). Correctness comes from rows 2–8. |
