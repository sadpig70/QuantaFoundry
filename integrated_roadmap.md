...
> 권위 현재상태: 67모듈(61 Tier-0 + 6 Tier-2 Clifford)·97앱·root `2cfe8dc3`·frozen 23키 (REGISTRY-MANIFEST.json). ※성장 이력(순수 비파괴): v0.7-core 48모듈·`3dae613d` → W2.4 c7x·cr8 50모듈·`437efbc3` → W6.1 cmul(mod91/77/85) → W6.3 iqft8 → W6.4 cr6/7/8_gate+qft5~8 53모듈·67앱 → W6.5 capstone **shor91(7×13, Tier-1 STRUCTURAL)**+cmul4/16/74_mod91 71앱·`93183bcd` → W7.1 QEC stabilizer 인코더(repcode3 bit/phase·syndrome3·**shor9_encoder [[9,1,3]]** Clifford Tier-0) 75앱·`06ca92d7` → W7.2 QEC Tier-2(stabilizer-tableau): Steane[[7,1,3]] |0>/|1>·shor9 재봉인 56모듈·`36e7014c` → W7.3 FT 논리게이트(transversal H/S/CNOT, 논리 CNOT **14q** dense-free) 59모듈·`3a85407d` → W8.1 Hamiltonian-sim(Trotter): Pauli-exp 회전 rz/rx + rzz/TFIM step, 정직-근사(오차=관찰) 61모듈·77앱·`d231fbf4` → W8.2 TrotterDeepening: {rxx,ryy,rzz} 완성+Heisenberg family(single-bond 정확/chain 근사)+복리, 수렴관찰 O(1/k) 62모듈·82앱·`59b88d50` → W8.3 SuzukiTrotter: 2차 대칭 Suzuki step+4q 격자, 차수 대비(1차 O(1/k) vs 2차 O(1/k²)) 63모듈·86앱·`566b0368` → W8.4 TrotterDynamics: 봉인 step 반복실행→시간동역학 관찰(봉인 0·root 불변), 차수 basis-의존(Z-blind/X-우월) 63모듈·86앱·`566b0368`(불변) → W9.1 AmplitudeAmplification: Grover 일반화(3q 확산/연산자+반복, 신규 모듈 0), 진폭증폭 프로파일(N=8 최적-k=2 P=0.945·over-rotation) 63모듈·91앱·`3e3d6fe7` → W9.2 AmplitudeEstimation(QAE): Grover Q=Ry(π/2)에 QPE(t=3)→진폭 추정(analytic Ry 4모듈+controlled-Ry+qae3_pi8 4q, iqft3 복리), exact a=sin²(π/8) 양 peak 정확복원 67모듈·94앱·`a916c8da` → W9.3 QAEDeepening: 2nd QPE-QAE(a=1/2, 신규 모듈 0)+iterative/power QAE(QPE-free, backend_adapter 실행, P_good(m) 고전fit→일반 θ a=1/4·1/8 추정) 67모듈·97앱·`2cfe8dc3`.
