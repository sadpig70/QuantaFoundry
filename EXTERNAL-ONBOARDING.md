...
- **W12 (cross-runtime: the codex runtime drove W12.1–W12.18, the Claude Opus runtime W12.19 +
  ...
  *exact*, zero new modules), **coined quantum walks** (C4/C8, zero new modules), **4th-order
  ...
  root unchanged); *(b)* a `c8x→c9x→c10x→c11x→c12x` multi-control primitive ladder unlocking distinct-prime
  **Shor structural apps** `shor119`/`shor221`/`shor381`/`shor635`/`shor1285`/`shor3683` (each a Tier-1 Merkle over
